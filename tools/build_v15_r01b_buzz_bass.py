#!/usr/bin/env python3
"""Build v15 R01b: Channel-10 BUZZ BASS with matched Note On/Off voice.
...
Off used the current UI patch. R01b routes both proven memcpy sites through the
same Channel-10 wrapper and uses official-v15 bank 3 preset 0, BUZZ BASS.
...
BANK = 3
PRESET = 0
VOICE_OFFSET = 0xF7000
VOICE_NAME = b"BUZZ BASS "
...
def main() -> int:
    ...
    manifest = {
        "format": "smk37-v15-r01b-channel10-factory-buzz-bass-noteoff-v1",
